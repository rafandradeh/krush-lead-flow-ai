...
const ProblemsSection: React.FC<ProblemsSectionProps> = ({
  ...
  return <section className="py-20 bg-gray-100 dark:bg-gray-800">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {t.problems.map((problem, index) => <Card key={index} className="bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 border-l-4 border-red-500">
        ...
        <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-2xl p-8 md:p-12 text-white">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {t.solution.points.map((point, index) => <div key={index} className="flex items-start">
